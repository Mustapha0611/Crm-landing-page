    ...
    <>
      ...
      id="hero">
        <section className="flex-1 py-0 pb-10 md:pb-0 px-10">
          ...
          <p className="text-base text-slate-800 pr-5 pb-10" data-aos="fade-in" data-aos-delay="1000">
        ...
        <section className="flex-1 flex items-center justify-end">
          <span className="w-full flex justify-end md:h-[25rem] lg:h-[30rem] h-[20rem]" data-aos="fade-left" data-aos-delay="500">
